      ...
      <div id="terms">
        <div className="container">
          <div className="navbar-offset">
            ...
            <p>
              Welcome to Wanderlog (“Travelchime Inc.”, “Company”, “we”, “our”,
            ...
            <p>
              ...
              use of our web pages located at https://wanderlog.com and our
              mobile application Wanderlog (together or individually “Service”)
              operated by Travelchime Inc.
            </p>
            <p>
              Our Privacy Policy also governs your use of our Service and
              explains how we collect, safeguard and disclose information that
              results from your use of our web pages. Please read it here at{" "}
              <Link to="/">https://wanderlog.com/privacy.</Link>
            </p>
            <p>
            ...
            <p>
              ...
              support@wanderlog.com so we can try to find a solution. These
            ...
            <p>
              ...
              Travelchime Inc. to charge all Subscription fees incurred through
              your account to any such payment instruments.
            </p>
            <p>
              Should automatic billing fail to occur for any reason, Travelchime
            ...
            <p>
              Travelchime Inc. may, at its sole discretion, offer a Subscription
            ...
            <p>
              ...
              Trial, you will not be charged by Travelchime Inc. until Free
            ...
            <p>
              At any time and without notice, Travelchime Inc. reserves the
            ...
            <p>
              Travelchime Inc., in its sole discretion and at any time, may
            ...
            <p>
              Travelchime Inc. will provide you with a reasonable prior notice
            ...
            <p>
              Travelchime Inc. has the right but not the obligation to monitor
              and edit all Content provided by users.
            </p>
            <p>
              In addition, Content found on or through this Service are the
              property of Travelchime Inc. or used with permission. You may not
            ...
            <p>
              You are not allowed to post content that is offensive,
              insensitive, upsetting, intended to disgust, in exceptionally poor
              taste, or just plain creepy. Examples of such content include:
            </p>
            <ul>
              <li>
                ...
                groups, particularly if the content is likely to humiliate,
                intimidate, or harm a targeted individual or group.
              </li>
              <li>
              ...
              <li>
                ...
                Dictionary as “explicit descriptions or displays of sexual
                organs or activities intended to stimulate erotic rather than
              ...
              <li>
                Intentionally false and misleading information, including
                inaccurate place data or false content that resemble jokes.
              </li>
            </ul>
            <p>
              If you discover objectionable content, you may use the in-app
              reporting functionality to alert us to it. If we deem the content
              to be objectionable, we will usually take action within 24 hours.
            </p>
            <p>
              Wanderlog will promptly remove objectionable content and expel
              users who post objectionable content.
            </p>
            <h2 className="font-weight-bold mb-3 line-height-1 letter-spacing-03">
              9. Prohibited Uses
            </h2>
            ...
            <p>
              ...
              exclusive property of Travelchime Inc. and its licensors. Service
              is protected by copyright, trademark, and other laws of the United
              States. Our trademarks and trade dress may not be used in
              connection with any product or service without the prior written
              consent of Travelchime Inc..
            </p>
            <h2 className="font-weight-bold mb-3 line-height-1 letter-spacing-03">
              13. Error Reporting and Feedback
            </h2>
            <p>
              You may provide us directly at support@wanderlog.com with
            ...
            <p>
              ...
              that are not owned or controlled by Travelchime Inc.
            </p>
            <p>
              Travelchime Inc. has no control over, and assumes no
            ...
            <p>By email: support@wanderlog.com.</p>
          </div>
        </div>
      </div>
    </>
