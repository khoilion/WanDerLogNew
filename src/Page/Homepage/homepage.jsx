...
const Homepage = () => {
  ...
  return (
    <div>
      ...
      {/* =============================Messager__fixed==================================== */}
      {showMessager ? (<div className="modal__messager">
        <div className="message-fixed-modal">
          <div className="bg-white border__radius__messager">
            <div className="bg__modal__messager padding__modal__messager">
              <div onClick={hanDleChangeMessager} className="icon__close__message">
                <CgClose />
              </div>
              <div className="d-flex align-items-center">
                ...
                <div className="ms-3">
                  <p className="">
                    Thanks for planning with Wanderlog!
                  </p>
                  <p className="">
                    I'm Harry, a co-founder: how can I help?
                  </p>
                </div>
              </div>
            ...
            <div>
              <Link>
                <img className="img__footer" src="img/tiledesk-logo_new_gray.svg" alt="" />
              </Link>
            </div>
          </div>
        </div>
